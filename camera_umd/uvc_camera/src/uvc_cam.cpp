  ...
  width(_width), height(_height), fps(_fps), rgb_frame(NULL)
{
  ...
  try
  {
    ...
    set_control(10094849, 3); // Exposure, Auto (Changed by YL from 1 to 3 for auto-exposure, reference: http://answers.ros.org/question/10236/logitech-webcams-very-dark-when-using-uvc_cam/)
